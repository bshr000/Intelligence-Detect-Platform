...
from .Addmodules import (
    ...
    CMFM_ega_cross3,
    CMFM_ega_cross4,
    CMFM_lega_cross_gate2,
    CMFM_lega_cross_gate3,
    CMFM_lega_cross_gate4,
...
#-------------------------------------------------- zhaoxuyang begin------------------------------------------------------        
        ...
        elif m in {HybridAdd, HybridMulti}:
            # - [[-2, -1], 1, Add, [1]] # 25
            c2 = ch[f[0]]       #  ch[f[0]] 是因为f=[]，是一个列表。
            c1 = c2
            # print(c2)
            args = [c1, c2, *args[0:]]
            
        elif m in { CMCF, HCMT, AFR, MSCF, EnhancedMSCF,PDMF}:
            c1 = ch[f[0]]
            c2 = c1
            args = [c1, c2, *args[0:]]
            
        elif m in {BCFM_EGA, BCFM_EGA_ffn,CMFM,CMFM_abla_1,CMFM_abla_2,CMFM_abla_3}:
            c1 = ch[f[0]]
            c2 = c1
            args = [c1, c2, *args[0:]]
            
        elif m in {CMFM_ega, CMFM_cross, CMFM_gate, CMFM_ega_cross, CMFM_ega_gate, CMFM_cross_gate, CMFM_imp1,
        CMFM_imp2, CMFM_imp3, CMFM_imp4, 
        CMFM_order1, CMFM_order2,CMFM_order3, CMFM_order4, CMFM_order5, CMFM_order6,
        CMFM_lega1, CMFM_lega2, CMFM_lega3, CMFM_lega4,CMFM_lega5, CMFM_lega6,CMFM_lega7,
        CMFM_gate2, CMFM_gate3, CMFM_gate4,
        CMFM_cross_gate2,CMFM_cross_gate3,
        CMFM_ega_cross1, CMFM_ega_cross2, CMFM_ega_cross3, CMFM_ega_cross4,
        CMFM_lega_cross_gate2, CMFM_lega_cross_gate3, CMFM_lega_cross_gate4,
        CMFM_lega1_in, CMFM_lega2_in, CMFM_lega3_in, CMFM_lega4_in, CMFM_lega5_in, CMFM_lega6_in, 
        }:
            c1 = ch[f[0]]
            c2 = c1
            args = [c1, c2, *args[0:]]
